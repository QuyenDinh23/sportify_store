                    ...
                    <div className="flex items-center gap-4 text-sm text-muted-foreground mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <div
                          ...
                          style={{
                            backgroundColor: item.selectedColor?.hex || "#ccc",
                          }}
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center border border-border rounded-lg">
                          ...
                          <Button
                            ...
                            disabled={
                              item.quantity >= (item.availableStock || 999)
                            }
                          >
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-blue-800">
                  {selectedItemsTotal < 500000
                    ? `Thêm ${(500000 - selectedItemsTotal).toLocaleString(
                        "vi-VN"
                      )}đ vào giỏ hàng để được freeship!`
              ...
              {selectedItemsTotal < 500000 && (
                <>
                  ...
                  <p className="text-sm text-blue-600 mt-1">
                    Còn {(500000 - selectedItemsTotal).toLocaleString("vi-VN")}đ
                    để được freeship
                  </p>
                </>
              )}
                  ...
                  <div className="space-y-3">
                    <div className="flex gap-2">
                      <Input
                        ...
                        value={voucherInput}
                        onChange={(e) =>
                          handleVoucherInputChange(e.target.value)
                        }
                        className="flex-1"
                      />
                      ...
                      <DialogContent className="max-w-2xl">
                        ...
                        <div className="space-y-4">
                          <p className="text-sm text-muted-foreground">
                            Giảm giá/phiếu vận chuyển đủ điều kiện áp dụng sẽ
                            được hiển thị ở trang tiếp theo. Voucher chưa sử
                            dụng vẫn còn trong tài khoản của bạn.
                          </p>
                          ...
                          <div className="space-y-3">
                            <h4 className="font-medium">
                              MÃ ƯU ĐÃI - SỐ LƯỢNG CÓ HẠN
                            </h4>
                            <div className="space-y-2">
                              {Array.isArray(availableVouchers) &&
