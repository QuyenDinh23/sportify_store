    ...
    <div className="min-h-screen bg-background">
      <main style={{ display: "flex" }}>
        ...
        <div style={{ flex: 1, padding: "50px 150px" }}>
          ...
          <Link
            to={user.role === "admin" ? "/dashboard/account" : user.role === "staff-sale" ? "/staff-sale/dashboard/account" : "/staff-content/dashboard/account"  }
          ...
          >
            <ChevronLeft />{" "}
            <span style={{ marginLeft: "5px", fontSize: "18px" }}>Tài khoản</span>
          </Link>
          <div
            style={{
              width: "100%",
